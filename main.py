...
from utils.singleton import ensure_single_instance, cleanup_stale_locks
...
async def main():
    ...
    # Обеспечение единственности экземпляра
    singleton_lock = ensure_single_instance()
    ...
    def signal_handler(sig, frame):
        ...
        # Освобождаем блокировку при остановке
    ...
    try:
        ...
        # Обязательно освобождаем блокировку при любом завершении
        singleton_lock.release()
        print("\n" + "-" * 50)
